...
<body>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var html =
                '<div class="position-center "><div class="form-group input_address"><label for="exampleInputPassword1">Sản phẩm</label><select name="ware_house_id" class="form-control m-bot15 choose_category"><option value="">--Chọn sản phẩm--</option></select></div><div class="form-group "><label for="exampleInputEmail1">Số lượng</label><input type="text" name="order_detail_quantity" class="form-control" data-validation="required" data-validation-error-msg="Vui lòng điền thông tin" ></div></div><div class="col-12 text-right"><input class="btn btn-danger" id="remove" type="button" name="remove" value="Xoá" tabindex="-1"></div>'
