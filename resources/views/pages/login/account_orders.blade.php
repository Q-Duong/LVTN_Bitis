        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="account-sidebar">
                    ...
                    <div class="account-setting">
                        ...
                        <div class="account-setting-option {{ $route->uri == 'member/orders' ? 'active' : '' }}">
            ...
            <div class="col-lg-8 col-md-6 centered ">
                <section class="list-order">
                                ...
                                <div class="order-view-header">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                            <div class="order-view-code"><span>Mã đơn hàng: </span>
                                                {{ $order->order_code }}
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                ...
                                <div class="order-view-content">
                                    <div class="row">
                                        <div class="col-lg-2 col-md-2 col-sm-2">
                                            <img width="100%"
                                                src="{{ URL::to('uploads/product/' . $order->product_image) }}">
                                        </div>
                    ...
                    @endforeach
                    <div class="pagi">{{$getAllOrder->links('pagination::bootstrap-4')}}</div>
                </section>
            </div>
        </div>
