                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6" >
                        <div class="account-sidebar">
                            ...
                            <div class="account-setting">
                                ...
                                <div class="account-setting-option">
                                    <span class="account-setting-option-icon"> 
                                        <svg id="Outlined" xmlns="http://www.w3.org/2000/svg" class="ac-gn-bagview-nav-svgicon" width="25px" height="25px" viewBox="0 0 16 25">
                    ...
                    <div class="col-lg-8 col-md-6" >
                        ...
                        <div class="checkout__input">
                            ...
                            <input type="text" name="customer_first_name" placeholder="Họ và tên lót" value="{{ Session::get('user_firstname') }}" disabled>
                        </div>
                        <div class="checkout__input">
                            <p>Tên<span>*</span></p>
                            <input type="text" name="customer_last_name" placeholder="Tên" value="{{Session::get('user_lastname')}}" disabled>
                        </div>
                        <div class="checkout__input">
                            <p>Địa chỉ email<span>*</span></p>
                            <input type="text" name="customer_email" placeholder="Địa chỉ email" value="{{Session::get('user_email')}}" disabled>
                        </div>
                        <div class="checkout__input">
                            <p>Số điện thoại<span>*</span></p>
                            <input type="text" name="customer_phone" placeholder="Số điện thoại" value="{{Session::get('user_phone')}}" disabled>
                        </div>
                        <div class="checkout__input">
                        {{-- @php
                            $cust_id=Session::get('customer_id');
					    @endphp --}}
                            <a href="{{URL::to('/account-settings/'.Session::get('user_id'))}}"  type="submit" class="site-btn"><i class="fa fa-cog"></i> Cài đặt tài khoản</a>
                        </div>
