                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 centered">
                                <div class="checkout__input  {{ $errors->has('customer_first_name') ? 'has-error' : ''}}">
                                    ...
                                    <input type="text" name="customer_first_name" placeholder="Điền họ và tên lót" value="{{ old('customer_first_name') }}">
                            ...
                            <div class="col-lg-6 col-md-6 centered">
                                <div class="checkout__input  {{ $errors->has('customer_last_name') ? 'has-error' : ''}}">
                                    <p>Tên<span>*</span></p>
                                    <input type="text" name="customer_last_name" placeholder="Điền tên" value="{{ old('customer_last_name') }}">
