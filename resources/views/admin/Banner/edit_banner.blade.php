                ...
                <div class="position-center">
                    <form role="form" action="{{URL::to('/admin/banner/update/'.$edit_value->banner_id)}}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="banner_name" class="form-control" id="exampleInputEmail1" value="{{$edit_value->banner_name}}"
                                placeholder="Tên banner" data-validation="required" data-validation-error-msg="Vui lòng điền thông tin">
                        </div>
                        <div class="form-group">
