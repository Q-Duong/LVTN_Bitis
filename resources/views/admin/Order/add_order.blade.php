...
@section('admin_content')
    <div class="row">
        <div class="col-lg-12">
            <form role="form" action="{{ URL::to('/admin/order/save') }}" method="post" enctype="multipart/form-data">
                @csrf
                <section class="panel">
                ...
                <div class="position-center">
                    <div class="form-group {{ $errors->has('receiver_first_name') ? 'has-error' : '' }}">
                        ...
                        <input type="text" name="receiver_first_name" class="form-control" data-validation="required"
                            data-validation-error-msg="Vui lòng điền thông tin" value="{{ old('receiver_first_name') }}">
                        {!! $errors->first(
                            'receiver_first_name',
                ...
                <div class="panel-body">
                    <div class="position-center">
                        ...
                        <div class="form-group">
                            ...
                            <select name="product_type_id" data-id_type="0"
                                class="form-control m-bot15 choose_product_type">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" value="1" min="1" name="order_detail_quantity[]"
                                class="form-control order_detail_quantity">
                        </div>
                        <div class="form-group">
