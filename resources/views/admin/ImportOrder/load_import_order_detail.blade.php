        ...
        <div class="row">
            <div class="col-lg-2">
                <label for="exampleInputEmail1">
                    Danh mục: <span class="name-title">{{ $import_order_detail -> wareHouse -> product -> category -> category_name }}</span>
                </label>
            </div>
            <div class="col-lg-3">
                <label for="exampleInputEmail1">
                    Loại sản phẩm: <span class="name-title" >{{ $import_order_detail -> wareHouse -> product -> productType -> product_type_name }}</span>
                </label>
            </div>
            <div class="col-lg-5">
                <label for="exampleInputEmail1">
                    Sản phẩm: <span class="name-title">{{ $import_order_detail -> wareHouse -> product -> product_name }}</span>
                </label>
            </div>
            <div class="col-lg-1">
                <label for="exampleInputEmail1">
